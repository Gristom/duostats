        ...
        if not matchlistsolo1:
            ...
            for i in range(len(matchlistsolo1)):
                ...
                if j1['gameDuration'] < 360:
                    ...
                    u = User(summoner1id=sum1id, summoner2id=sum2id, matchid=j1['gameId'], regioncode=form.region.data, season=9, winorlose=2, soloduo=1, c1id=j1['participants'][pid1-1]['championId'], c2id=0, c1k=j1['participants'][pid1-1]['stats']['kills'], c1d=j1['participants'][pid1-1]['stats']['deaths'], c1a=j1['participants'][pid1-1]['stats']['assists'], c2k=0, c2d=0, c2a=0)
                    db.session.add(u)
                    db.session.commit()
                    ...
                    u = User(summoner1id=sum1id, summoner2id=sum2id, matchid=j1['gameId'], regioncode=form.region.data, season=9, winorlose=0, soloduo=1, c1id=j1['participants'][pid1-1]['championId'], c2id=0, c1k=j1['participants'][pid1-1]['stats']['kills'], c1d=j1['participants'][pid1-1]['stats']['deaths'], c1a=j1['participants'][pid1-1]['stats']['assists'], c2k=0, c2d=0, c2a=0)
        ...
        if not matchlistsolo2:
            ...
            for i in range(len(matchlistsolo2)):
                ...
                if j1['gameDuration'] < 360:
                    ...
                    u = User(summoner1id=sum1id, summoner2id=sum2id, matchid=j1['gameId'], regioncode=form.region.data, season=9, winorlose=0, soloduo=2, c1id=0, c2id=j1['participants'][pid2-1]['championId'], c1k=0, c1d=0, c1a=0, c2k=j1['participants'][pid2-1]['stats']['kills'], c2d=j1['participants'][pid2-1]['stats']['deaths'], c2a=j1['participants'][pid2-1]['stats']['assists'])
